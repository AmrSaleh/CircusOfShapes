...
public class PlayerOne {
	...
	private String nameOfImg = "Player\\p1.png";
	...
	private PlayerOne() {
		try {
			...
			System.out.println("Can't load Player 1 img.");
		}
	...
	/**
	 * @param lengthOfBumper
	 *            the lengthOfBumper to set
	 */
	...
	/**
	 * @param rightOldClearance
	 *            the rightOldClearance to set
	 */
	...
	/**
	 * @param rightNewClearance
	 *            the rightNewClearance to set
	 */
	...
	/**
	 * @param leftOldClearance
	 *            the leftOldClearance to set
	 */
	...
	/**
	 * @param leftNewClearance
	 *            the leftNewClearance to set
	 */
	...
	public void checkScore() {
		for (int i = 0; i < rightHandList.size() - 2; i++) {
			...
			if (rightHandList.get(i).getColor() == rightHandList.get(i + 1).getColor() && rightHandList.get(i + 1).getColor() == rightHandList.get(i + 2).getColor()) {
				score++;
				for (int j = i + 3; j < rightHandList.size(); j++) {
					rightHandList.get(j).setYPos(rightHandList.get(j).getYPos() - rightHandList.get(i).getHeight() - rightHandList.get(i + 1).getHeight() - rightHandList.get(i + 2).getHeight());
				}
				rightOldClearance = rightOldClearance - rightHandList.get(i).getHeight() - rightHandList.get(i + 1).getHeight() - rightHandList.get(i + 2).getHeight();
		...
		for (int i = 0; i < leftHandList.size() - 2; i++) {
			...
			if (leftHandList.get(i).getColor() == leftHandList.get(i + 1).getColor() && leftHandList.get(i + 1).getColor() == leftHandList.get(i + 2).getColor()) {
				score++;
				for (int j = i + 3; j < leftHandList.size(); j++) {
					leftHandList.get(j).setYPos(leftHandList.get(j).getYPos() - leftHandList.get(i).getHeight() - leftHandList.get(i + 1).getHeight() - leftHandList.get(i + 2).getHeight());
				}
				leftOldClearance = leftOldClearance - leftHandList.get(i).getHeight() - leftHandList.get(i + 1).getHeight() - leftHandList.get(i + 2).getHeight();
		...
		System.out.println(maxYLeft + " " + maxYRight);
